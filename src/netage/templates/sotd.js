...
export default (conf, opts) => {
  return html`
    ...
    ${conf.isUnofficial
      ? html`
          <p>
          This document is merely a Netage-internal document. It has no official standing of any kind and does not represent consensus with related parties. 
          </p>
          ...
          ${conf.isSubmission
            ...
            : html`
                ...
                ${conf.notRec
                  ? html`
                      <p>
                        Publication as ${conf.anOrA} ${conf.textStatus} does not
                ...
                <p data-deliverer="${conf.isNote ? conf.wgId : null}">
                  ${!conf.isIGNote
                    ? html`
                        ...
                        ${conf.multipleWGs ? "groups" : "a group"} operating
                        under the
